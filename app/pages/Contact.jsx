...
const Contact = () => {
  return (
    <motion.section className="flex flex-col gap-3 justify-center items-center"
    ...
    whileTap={{ scale: 0.9 }}
     className="bg-orange-400 p-3 px-6 rounded-lg text-white">Contact Me</motion.button>
    </div>
  </motion.section>
  )
}
